...
export const projetsData: Projet[] = [
  ...
  },
  {
    ...
    year: '2024-2025',
    description:
      'Transformer un tunnel de souscription complexe afin de clarifier les offres et améliorer la génération de devis.',
    tags: [
      'B2B2C',
      'Conversion',
      'UX Strategy',
    ...
    demarche: [
      ...
      },
      {
        ...
        content:
          "Refonte complète de l'architecture d'information afin de structurer les étapes de manière plus logique et progressive. Les questions ont été regroupées et organisées selon une logique step-by-step permettant de réduire la perception de longueur du parcours sans modifier la logique métier.",
      },
      {
        title: 'Refonte de la présentation des offres',
        content:
          'La phase de choix des offres a été entièrement repensée : nouvelle hiérarchie visuelle, clarification des garanties, introduction de micro-copy de réassurance, ajout de badges « offre recommandée ». Un récapitulatif final dynamique a également été introduit, inspiré des logiques de panier e-commerce.',
      },
      {
        title: 'Validation',
        content:
          "Deux variantes de la présentation des offres ont été testées via A/B testing afin d'identifier la structure la plus efficace. Le projet s'est conclu par une recette technique et visuelle complète en collaboration avec les développeurs.",
      },
    ],
    impact:
      "Les premiers retours utilisateurs et internes ont mis en évidence plusieurs améliorations.\n\n• Temps perçu du parcours divisé par deux : un parcours d'environ 30 minutes est ressenti comme une expérience de 10 à 15 minutes\n• Amélioration de la fluidité perçue et meilleure compréhension des offres\n• Suppression des principales frictions identifiées jusqu'à la demande de devis\n• Premiers retours internes indiquant une augmentation du volume de leads générés via le tunnel",
  ...
  },
  {
    ...
    year: '2024',
    description:
      "Créer un outil centralisant les leads et structurant l'activité commerciale des équipes.",
    tags: [
      'SaaS',
      'Product Design',
      'UX Strategy',
    ...
    demarche: [
      {
        ...
        content:
          "Des ateliers ont été organisés avec les équipes internes afin de comprendre leur fonctionnement quotidien et leurs contraintes. L'objectif était d'identifier les actions les plus fréquentes, les informations essentielles à afficher et les flux de travail des conseillers.",
      },
      {
        title: 'Structuration des données',
        content:
          'Un travail important a été réalisé pour organiser les informations et hiérarchiser les données clients. Chaque fiche assuré devait regrouper de manière claire : documents, historique des échanges, emails, commentaires et relances de devis.',
      },
      {
        title: 'Conception des interfaces',
        content:
          "Plusieurs interfaces clés ont été conçues : dashboard de suivi des leads, gestion du portefeuille avec filtres et alertes, fiche assuré centralisant les informations clients, ainsi qu'un module de tarification permettant de recueillir les besoins et comparer les offres.",
      },
      {
        title: 'Pilotage des leads',
        content:
          'Le CRM intègre un système permettant de dispatcher les leads aux conseillers, définir des règles de distribution selon leur origine, suivre les quotas par équipe et gérer les leads non attribués.',
      },
    ],
    impact:
      "La mise en place du CRM permet désormais aux équipes commerciales de :\n\n• Centraliser l'ensemble des données clients\n• Gérer plus efficacement les leads entrants\n• Suivre leur activité et leurs performances\n• Améliorer l'organisation du travail des conseillers\n\nL'outil constitue aujourd'hui un élément structurant de l'écosystème digital interne.",
    image: crmBBHeroImage,
    gallery: [crmBBScreensImage],
  },
  {
    id: 'agpt',
    ...
    year: '2024',
    description:
      "Lancer une identité et une plateforme digitale dédiée à l'accompagnement des femmes.",
    ...
    objectifProduit:
      "Proposer des contenus et programmes d'accompagnement via des clubs thématiques",
    contexte:
    ...
    demarche: [
      {
        ...
        content:
          "Conception de l'identité visuelle complète : logo, palette de couleurs et typographies. L'objectif était de créer un univers chaleureux et moderne tout en conservant une dimension crédible et institutionnelle.",
      },
      {
        title: 'Définition de la direction artistique',
        content:
          "Création d'un univers graphique cohérent permettant de structurer l'image de la marque sur l'ensemble de ses supports digitaux et événementiels.",
      },
      {
        title: 'Conception de la plateforme',
        content:
          "Design du site web permettant de présenter la mission d'AGPT, valoriser les contenus proposés et commercialiser les clubs thématiques.",
      },
      {
        title: 'Accompagnement des fondatrices',
        content:
          'Travail en collaboration directe avec les fondatrices pour clarifier leurs idées, ajuster les propositions graphiques et faire évoluer la direction artistique à travers plusieurs itérations.',
      },
    ],
    impact:
  ...
  // ─ Autres Projets (avec pages détail) ─────────────────────────
  {
    ...
    year: '2025',
    description:
      "Imaginer un site plus clair et orienté conversion pour soutenir l'acquisition digitale.",
    tags: [
      'UX Strategy',
      'Website redesign',
      'Conversion',
    ...
    demarche: [
      {
        ...
        content:
          "Étude de l'architecture du site et de ses pages produits afin d'identifier les problèmes de lisibilité et de navigation dans un écosystème comprenant plusieurs centaines de pages.",
      },
      {
        title: "Simplification de l'architecture",
        content:
          "Proposition d'une nouvelle structure de navigation permettant d'accéder plus rapidement aux offres et de clarifier la hiérarchie des informations.",
      },
      {
        title: "Refonte de l'expérience utilisateur",
        content:
          "Conception de nouvelles maquettes mettant l'accent sur la pédagogie des offres, la réassurance et une hiérarchie visuelle plus claire.",
      },
      {
        title: 'Vision orientée acquisition',
        content:
          "Intégration d'une logique plus orientée conversion avec une mise en avant plus claire des parcours de devis et une meilleure valorisation des offres.",
      },
    ],
    impact:
  ...
  },
  {
    ...
    year: '2024',
    description:
      "Redéfinir l'identité visuelle du groupe pour moderniser son image et harmoniser ses supports.",
    tags: [
      'Branding',
    ...
    demarche: [
      {
        ...
        content:
          "Étude de la charte graphique actuelle afin d'identifier les éléments devenus obsolètes et les incohérences apparues avec le temps entre les différents supports de communication.",
      },
      {
        title: "Définition d'une nouvelle direction visuelle",
        content:
          "Proposition d'une direction artistique plus moderne et plus crédible, capable de mieux s'inscrire dans l'univers de l'assurance tout en conservant l'identité historique de la marque.",
      },
      {
        title: "Construction d'un système de marque",
        content:
          "Création d'une proposition complète incluant logo, palette de couleurs, typographies, iconographie et principes de design system pour structurer l'ensemble des supports de communication.",
      },
      {
        title: 'Présentation et échanges stratégiques',
        content:
          "Présentation de la proposition à la direction afin de nourrir la réflexion sur l'évolution future de l'identité du groupe.",
      },
    ],
    impact:
      "Le projet n'a finalement pas été déployé en raison de changements importants au sein de la direction.\n\nCependant, cette proposition a permis de :\n\n• Ouvrir la réflexion sur l'évolution de l'image de SPVIE\n• Démontrer la capacité de l'équipe design à penser l'identité du groupe à une échelle stratégique",
    image: charteSPVIEFullImage,
    gallery: [charteSPVIEHeroImage],
    pdfUrl:
      'https://www.dropbox.com/scl/fi/3a4ngxrs8rm9imyi0nx1q/Charte-Graphique_wm.pdf?rlkey=w9c7jseefqxuc374hvs70f30r&st=ru0u4817&dl=1',
  },
  {
    id: 'mobile-cgrm',
    ...
    year: '2024',
    description:
      "Moderniser l'interface mobile afin d'améliorer la lisibilité et l'expérience assurée.",
    tags: [
      'Mobile app',
      'UI redesign',
      'Product design',
    ...
    demarche: [
      {
        ...
        content:
          "Étude de l'application mobile afin d'identifier les éléments visuels obsolètes et les points d'amélioration en termes de lisibilité et d'accessibilité.",
      },
      {
        title: 'Adaptation à la charte graphique',
        content:
          "Application de la charte graphique existante afin d'harmoniser l'interface avec les autres produits digitaux du groupe.",
      },
      {
        title: 'Refonte des composants mobiles',
        content:
          'Modernisation des composants UI et amélioration de la hiérarchisation des informations pour faciliter la lecture et la navigation.',
      },
      {
        title: 'Collaboration technique',
        content:
          "Travail en collaboration avec les développeurs afin d'assurer la cohérence entre les maquettes et l'implémentation finale, avec une recette fonctionnelle et visuelle complète.",
      },
    ],
    impact:
      "La refonte a permis de :\n\n• Moderniser l'interface mobile\n• Améliorer la lisibilité des informations\n• Renforcer la cohérence avec les autres produits digitaux du groupe\n\nLes retours internes ont été positifs, notamment sur la clarté et la modernisation de l'expérience mobile.",
    image: cgrmHeroImage,
    gallery: [cgrmScreensImage],
  },
];
