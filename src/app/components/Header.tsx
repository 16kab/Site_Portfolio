      ...
      >
        ...
        >
          ...
          <div className="hidden lg:flex absolute right-[22.58px] top-1/2 -translate-y-1/2 items-center gap-10">
            ...
            <div className="flex gap-[27px] items-center">
              ...
              >
                <motion.p
                  ...
                  style={{
                    opacity: hoveredItem && hoveredItem !== 'projets' ? 0.4 : 1
                  }}
                >
                  Projets
                </motion.p>
              ...
              >
                <motion.p
                  ...
                  style={{
                    opacity: hoveredItem && hoveredItem !== 'apropos' ? 0.4 : 1
                  }}
                >
                  À propos
                </motion.p>
            ...
            <div className="flex items-center gap-4 transition-opacity duration-300" style={{ opacity: hoveredItem ? 0.4 : 1 }}>
              {/* Contact Button */}
              <motion.button
